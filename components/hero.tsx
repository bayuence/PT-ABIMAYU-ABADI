...
const slides = [
  {
    ...
    youtubeId: 'Xt_4xd6wxss',
    tag: 'GENERAL CONTRACTOR',
    duration: 35000, // Ganti durasi ini agar pas dengan video Anda (35000 = 35 detik)
  },
  {
    id: 2,
    ...
    duration: 20000, // Contoh: Slide ini pindah setelah 20 detik
  },
  {
    id: 3,
    ...
    duration: 25000, // Contoh: Slide ini pindah setelah 25 detik
  }
]
            ...
            <div className="flex-1 flex gap-2 sm:gap-6">
              {slides.map((slide, index) => (
                ...
                >
                  ...
                  <h3 className={`text-[10px] sm:text-xs md:text-sm font-semibold tracking-wider transition-colors duration-300 line-clamp-1 uppercase ${
                    current === index ? 'text-white' : 'text-gray-500 group-hover:text-gray-300'
                  }`}>
                    {slide.title}
                  </h3>
                </button>
